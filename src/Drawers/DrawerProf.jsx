...
const DrawerProf = () => {
  ...
  const handleNavigationToMainProf = () => {
    navigation.navigate('MainProf'); // Navigate to MainProf screen
  ...
  return (
    ...
    >
      <View style={styles.drawer}>
        ...
        <TouchableOpacity style={styles.drawerButton} onPress={handleNavigationToMainProf}>
